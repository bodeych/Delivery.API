...
public sealed class Order
{
    ...
    // EF ctor
    private Order(Guid id, Guid creatorId, Distance distance, decimal cost)
    {
        Id = id;
        CreatorId = creatorId;
        Distance = distance;
    ...
    private Order(Guid id, Guid creatorId, Coordinate pickup, Coordinate dropoff, Distance distance, decimal cost)
    {
        Id = id;
        CreatorId = creatorId;
        Pickup = pickup;
